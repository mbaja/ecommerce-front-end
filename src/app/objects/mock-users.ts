...
export const USERS: User[] = [
  {
    ...
    type: "customer"             // string VARCHAR(10) NULL COMMENT 'Either \'Admin\', \'Customer\', or \'Vendor\''
  },
  {
    ...
    email:       "tomsal@gmail.com",     // string VARCHAR(50) NOT NULL COMMENT 'Will be used as the username for logging in
                  // Date DATE NULL
    phone: "(420)420-1488",       // string VARCHAR(50) NULL
    password:     "bucci",               // string VARCHAR(100) NOT NULL COMMENT 'Contains an encrypted password of the customer
    address:       "69 Supreme address",   // string VARCHAR(50) NULL
    zip:          90211,                 // number INT NULL
    city:         "Brick City",          // string VARCHAR(50) NULL
    state:        "CA",                  // string CHAR(2) NULL
    country:      "USA",                 // string VARCHAR(50) NULL,
    type: "user"             // string VARCHAR(10) NULL COMMENT 'Either \'Admin\', \'Customer\', or \'Vendor\''
  },
  {
    ...
    state:        "CA",                  // string CHAR(2) NULL
    country:      "USA",                 // string VARCHAR(50) NULL,
    type: "admin"                // string VARCHAR(10) NULL COMMENT 'Either \'Admin\', \'Customer\', or \'Vendor\''
  },
  {
